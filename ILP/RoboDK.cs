...
public class Mat // simple matrix class for homogeneous operations
{
    ...
    /// <param name="iCols">The i cols.</param>
    /// <returns></returns>
...
public class RoboDK
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RDKException"/> class.
        /// </summary>
    ...
    public class Item
    {
        ...
        /// </summary>
        /// <param name="connection_link">The connection link.</param>
        /// <param name="item_ptr">The item PTR.</param>
